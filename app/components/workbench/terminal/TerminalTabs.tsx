                  ...
                  {index == 0 ? (
                    <button
                      ...
                      className={classNames(
                        'flex items-center text-sm cursor-pointer gap-1.5 px-3 py-2 h-full whitespace-nowrap rounded-md',
                        {
                          'bg-black text-white hover:bg-gray-900':
                            isActive,
                          'bg-bolt-elements-background-depth-2 text-bolt-elements-textSecondary hover:bg-black hover:text-white':
                            !isActive,
                        },
                      )}
                    ...
                    <React.Fragment>
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-gray-400 hover:text-white hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
