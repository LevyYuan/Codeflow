...
export function McpTools({ compact }: { compact?: boolean }) {
      ...
      <div className="flex">
        {compact ? (
          <button
            ...
            className="w-8 h-8 flex items-center justify-center rounded-full hover:bg-bolt-elements-item-backgroundActive transition-all text-bolt-elements-textSecondary hover:text-bolt-elements-text-primary disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {!isInitialized ? (
