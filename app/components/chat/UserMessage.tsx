...
export function UserMessage({ content, parts }: UserMessageProps) {
  ...
  if (Array.isArray(content)) {
    ...
    return (
      <div className="overflow-hidden flex flex-col gap-2 items-center">
        ...
        <div className="flex flex-col gap-4 bg-gray-100 dark:bg-gray-800 px-3 py-2.5 w-auto rounded-lg mr-auto [&_p]:!my-0 [&_div]:!my-0">
  ...
  return (
    <div className="flex flex-col bg-gray-100 dark:bg-gray-800 px-5 py-2.5 w-auto rounded-lg ml-auto [&_p]:!my-0 [&_div]:!my-0">
