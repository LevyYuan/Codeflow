  ...
  return (
    <div className="flex gap-3 flex-col sm:flex-row">
      ...
      <div className="relative flex-1" onKeyDown={handleProviderKeyDown} ref={providerDropdownRef}>
        <label className="block text-xs font-medium text-bolt-elements-textSecondary mb-1.5">Provider</label>
        <div
          className={classNames(
            'w-full p-2.5 rounded-xl border border-bolt-elements-borderColor',
            'bg-bolt-elements-background-depth-1 text-bolt-elements-textPrimary',
            'focus-within:outline-none focus-within:ring-2 focus-within:ring-bolt-elements-borderColorActive',
            'transition-all cursor-pointer text-sm',
            isProviderDropdownOpen ? 'ring-2 ring-bolt-elements-borderColorActive' : undefined,
          )}
      ...
      {/* Model Combobox */}
      <div className="relative flex-[2]" onKeyDown={handleModelKeyDown} ref={modelDropdownRef}>
        <label className="block text-xs font-medium text-bolt-elements-textSecondary mb-1.5">Model</label>
        <div
          className={classNames(
            'w-full p-2.5 rounded-xl border border-bolt-elements-borderColor',
            'bg-bolt-elements-background-depth-1 text-bolt-elements-textPrimary',
            'focus-within:outline-none focus-within:ring-2 focus-within:ring-bolt-elements-borderColorActive',
            'transition-all cursor-pointer text-sm',
            isModelDropdownOpen ? 'ring-2 ring-bolt-elements-borderColorActive' : undefined,
          )}
