...
export default defineConfig({
  ...
  shortcuts: {
    ...
    'glass-card': 'bg-white/60 dark:bg-black/60 backdrop-blur-md border border-black/8 dark:border-white/10',
    'hover-lift': 'transition-all duration-200 hover:-translate-y-0.5 hover:shadow-lg',
    'btn-primary': 'bg-black dark:bg-white text-white dark:text-black font-medium rounded-full px-4 py-2 hover:bg-gray-800 dark:hover:bg-gray-200 transition-all hover:scale-105 active:scale-95',
    'btn-secondary': 'bg-gray-100 dark:bg-white/10 text-gray-900 dark:text-white font-medium rounded-full px-4 py-2 border border-gray-200 dark:border-white/10 hover:bg-gray-200 dark:hover:bg-white/15 transition-all',
  },
  rules: [
    /**
